...
dataset_train.load_data('Annotations\\Label\\labels.json', 'Annotations')
dataset_train.prepare()

#In this example, I do not have annotations for my validation data, so I am loading train data
dataset_val = CocoLikeDataset()
dataset_val.load_data('Annotations\\Label\\labels.json', 'Annotations')
dataset_val.prepare()
...
COCO_WEIGHTS_PATH = os.path.join(ROOT_DIR, "Mask_RCNN-master\mask_rcnn_coco.h5")
...
marbles_img = skimage.io.imread("Annotations\\Test\\frame_550.jpg")
plt.imshow(marbles_img)

detected = model.detect([marbles_img], verbose=1)
results = detected[0]
class_names = ['person', 'atm']
...
detect_and_color_splash(model, image_path="Annotations\\Test\\frame_550.jpg")
